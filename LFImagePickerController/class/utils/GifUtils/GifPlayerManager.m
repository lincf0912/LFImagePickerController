...
@implementation GifPlayerManager

static GifPlayerManager *_sharedInstance = nil;
+ (GifPlayerManager *)shared{
    if (_sharedInstance == nil) {
        _sharedInstance = [[GifPlayerManager alloc] init];
    }
